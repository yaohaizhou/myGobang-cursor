...
void Board::printBoard()
{
    ...
    {
        sf::Vertex line[] = {
            sf::Vertex(sf::Vector2f(i, 60)),
            sf::Vertex(sf::Vector2f(i, 480))
        };
        window.draw(line, 2, sf::Lines);

        sf::Vertex hline[] = {
            sf::Vertex(sf::Vector2f(60, i)),
...
/**
 * @name: getMouseLoc
 * @msg: Get mouse position and map it to the real chessboard. The chessboard starts at (60, 60) and has lines every 30 pixels.
 * @param none
 * @return: void
 */
